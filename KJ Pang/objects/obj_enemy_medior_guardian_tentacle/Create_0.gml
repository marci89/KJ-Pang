...
if (isLeftSide) {
	...
	if (creatorType == tentacleType.BlueBallMediorCreator) {
	...
	} else if (creatorType == tentacleType.YellowBallMediorCreator) {
	...
	} else if (creatorType == tentacleType.ShieldBallMediorCreator) {
	...
	normalBallColorType.Blue, false,2);
	
			CreateNormalBallMediumShield(x, y, global.normalBallMediumMoveX, global.normalBallMediumMoveY,
	global.normalBallMediumGravityY, global.normalBallMediumJumpHeightMax,
	normalBallColorType.Blue, false,2);
	
				CreateNormalBallMediumShield(x, y, -global.normalBallMediumMoveX-2, global.normalBallMediumMoveY-2,
	global.normalBallMediumGravityY, global.normalBallMediumJumpHeightMax,
	normalBallColorType.Blue, false,2);
