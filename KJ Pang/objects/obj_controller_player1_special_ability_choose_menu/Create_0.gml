...
function GetSelectedItemInformationType() {
		...
		var totalItems = instance_number(obj_player1_special_ability_item_button);
		
			for (var i = 0; i < totalItems; i++) {	
			    var item = instance_find(obj_player1_special_ability_item_button, i);
				  if (item != noone) {
...
for (var i = 0 ; i < itemNumber; i++) {
 ...
 //back button
 var backButton = instance_create_layer(startX + 150, buttonY,"TopLayer", obj_player1_special_ability_menu_back_button);
