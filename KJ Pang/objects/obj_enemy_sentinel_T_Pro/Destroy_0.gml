...
CreateLifePointWithMovement(x,y,1.5,-1, lifePointType.Green);
CreateLifePointWithMovement(x,y,-1.5,-1, lifePointType.Green);
CreateLifePointWithMovement(x,y,0.5,-2, lifePointType.Green);
CreateLifePointWithMovement(x,y,-0.5,-2, lifePointType.Green);
CreateLifePointWithMovement(x,y,1,-2, lifePointType.Green);
CreateLifePointWithMovement(x,y,1,-2, lifePointType.Green);
